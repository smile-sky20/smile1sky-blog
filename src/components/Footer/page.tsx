...
export default function Footer() {
  ...
  return (
    <div className={`px-6 max-h-[240px] border-t border-accents2 bg-background`}>
      <div className="footer-warp py-9 flex justify-between">
        <svg fill="none" height="20" viewBox="0 0 283 64">
          <path
            ...
            fill={useTheme.activeTheme === 'dark-theme' ? '#fff' : '#000'}
          ></path>
        </svg>
